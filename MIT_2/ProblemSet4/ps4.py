...
def generate_models(x, y, degs):
    ...
    line_coef = []
    for i in degs:
        line_coef.append(np.polyfit(xVals, yVals, i))
    return line_coef
...
# Problem 3
def evaluate_models_on_training(x, y, models, degs, tilte):
    """
...
degs = [1]
city = 'BOSTON'
title='Yearly Temp in '+ city 
for year in INTERVAL_1:
    y.append(raw_data.get_daily_temp(city, 1, 10, year))
models = generate_models(x, y, degs)
evaluate_models_on_training(x, y, models,degs,title)


#Problem 4: FILL IN MISSING CODE TO GENERATE y VALUES
degs = [1]
city = 'BOSTON'
title='Yearly Temp Data in '+ city 
x1 = INTERVAL_1
x2 = INTERVAL_2
y = []
x = x1 + x2
...
#print(y)
models = generate_models(x1, y, degs)    
evaluate_models_on_training(x1, y, models, degs, title)
