...
def powerSet(items):
    """For the following problem, consider the following way to write
       ...
       put n items into one bag is  2n . Here, items is a Python list.
       With one bag we determined there were  2n  possible combinations
       ...
       there must be  2n  possibilities.
    """
    N = len(items)
...
def yieldAllCombos(items):
    """
        ...
        - thus there must be  3n  possible combinations.
    """
    N = len(items)
